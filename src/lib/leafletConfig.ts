...
/**
 * Initializes Leaflet default icon settings.
 * This function must only be called on the client side (e.g., inside useEffect).
 */
...
// Export L for use in components if needed.
export { L };