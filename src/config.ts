...
export const SUPABASE_API_TIMEOUT = parseInt(import.meta.env.VITE_SUPABASE_API_TIMEOUT as string, 10) || 60000; // Increased to 60 seconds (60000 ms) for diagnosis
