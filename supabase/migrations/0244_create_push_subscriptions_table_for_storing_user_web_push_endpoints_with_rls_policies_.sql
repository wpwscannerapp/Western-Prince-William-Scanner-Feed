...
-- Create the unique index separately to ensure correct syntax for functional index
CREATE UNIQUE INDEX push_subscriptions_unique_endpoint_per_user ON public.push_subscriptions (user_id, (subscription->>'endpoint'));
